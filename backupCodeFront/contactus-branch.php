<?php 
	...
	$bran 	= $db->result(DB_PREFIX.'branch');
...
<div class="content">
	...
	<section class="right-col">
		...
		<div style="margin-top:30px; float:left; margin-left:22px;">
			<?php 
				if($bran){
					foreach($bran as $rs_bran){
							echo '<div class="branch-list">
									<div class="map">
										<a href="#'.$rs_bran->id_branch.'">
											<img src="images/news/'.$rs_bran->branch_img.'" alt="minimap" width="205" height="145">
										</a>
									</div>
									<div class="address">
										<ul class="contact-detail">
											<li>'.$rs_bran->branch_name.'</li>
											<li>เลขที่สาขา : '.$rs_bran->branch_number.'</li>
											<li>'.$rs_bran->branch_detail.'</li>
											<li>โทร : '.$rs_bran->branch_tel.'</li>
											<li>แจ้งอุบัติเหตุโทร : '.$rs_bran->branch_emergency.'</li>
										</ul>
									</div>
								</div>';
					}
			...
			<!--<div class="branch-list">
				<div class="map">
					<a href="#">
						<img src="images/minimap.jpg" alt="minimap" width="205" height="145">
					</a>
				</div>
				<div class="address">
					<ul class="contact-detail">
