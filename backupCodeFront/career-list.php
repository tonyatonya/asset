<?php 
	...
	$sing	= $db->result(DB_PREFIX.'office');
?>
<!DOCTYPE html>
<html lang="">
...
window.location.replace("career-form.php?aaa="+aaa+"");
}
</script>
...
<div class="content">
	...
	<section class="right-col">
		...
		<div class="product-name">
			<div class="ico"><img src="images/ico/assetIcon15.png" alt="exampleicon" width="46" height="46" /></div>
				...
				foreach($sing as $s){								
					echo '
						...
						<li class="position-name">
							<a href="#">'.$s->office_topic.'<span> คลิกเพื่อดูรายละเอียด </span></a> <div class="temp">จำนวน '.$s->office_amount.' อัตรา</div>
								<div class="job-detail">
								<div class="job-topic">รายละเอียด</div>
							'.$s->offce_detail.'
							<div class="job-topic">ประกาศเมื่อ : '.$s->date_office.'</div>
								<div class="btn-holder">
									
										<input type="hidden" value="'.$s->office_topic.'" name="pic" id="pic">
										<input type="submit"  value="สนใจสมัครตำแหน่งงานนี้"  onclick="myFunction(\''.$s->office_topic.'\')">
